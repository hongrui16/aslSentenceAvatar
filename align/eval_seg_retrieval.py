...
def main():
    ...
    ap.add_argument('--tok_dir', default='/projects/kosecka/hongrui/dataset/smplx_fits/pooled_tokens/vq_K512_w64'); ap.add_argument('--chunk_dir', default=f'{DR}/chunks'); ap.add_argument('--merge', type=int, default=1); ap.add_argument('--spots', default='')
