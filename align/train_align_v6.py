"""v6 (2026-09-17): identical to train_align.py (v1 MIL-NCE recipe) except the text units come from pseudo-gloss keywords
(align_dataset_v2 + --chunk_dir <gloss dir>): one lemmatized content word per unit, no tense/plural/function words (user 09-17).
...
def main():
    ...
    ap.add_argument('--chunk_dir', default='/home/rhong5/research_pro/hand_modeling_pro/asl_data_curation/data_records/alignment/gloss')
    ...
    ap.add_argument('--out_dir', default='/scratch/rhong5/weights/temp_training_weights/aslSentenceAvatar/Align_Pooled'); ap.add_argument('--tag', default='align_g1'); ap.add_argument('--seed', type=int, default=0)
