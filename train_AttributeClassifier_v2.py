"""
Train Handshape Classifier V2 (ResNet50 + Temporal Attention)
==============================================================
Usage:
    python train_AttributeClassifier_v2.py --task finger    # Selected Fingers (10 classes)
    python train_AttributeClassifier_v2.py --task handshape # Flexion (9 classes)
"""
...
from network.HandshapeClassifierV2 import HandshapeClassifierV2
...
def main(args):
    ...
    # ── Resolve task ──
    task = args.task
    _, class_names, _, num_classes = get_task_info(task)
    ...
    logger.info(f'Task: {task} ({num_classes} classes)')
...
if __name__ == '__main__':
    p = argparse.ArgumentParser(description='Train Handshape Classifier V2')
    ...
    p.add_argument('--log_dir', type=str, default='./zlog/AttributeClassifier_v2')
    p.add_argument('--ckpt_dir', type=str,
                   default='/scratch/rhong5/weights/temp_training_weights/aslSentenceAvatar/AttributeClassifier_v2')
